...
@pytest.fixture(params = USERS_UPDATED, ids = get_test_case_id_payload_expected_id)
def user_updated_raw_data(request) -> dict:
    return (request.param[0], request.param[1])

@pytest.fixture(params = USERS_UPDATED_INVALID, ids = get_test_case_id_payload_id)
